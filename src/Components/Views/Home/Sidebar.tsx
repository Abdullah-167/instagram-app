...
const Sidebar = () => {
  ...
  return (
    <div className={`${isChatPage ? 'max-w-[80px] min-w-[80px]' : 'max-w-[245px] min-w-[245px]'} max-w-[245px] min-w-[245px] z-[1000] bg-white`}>
      <div
        className={`border-r border-r-gray-300 z-[1000] fixed left-0 top-0 pr-2  transition-all duration-500 ${textVisible ? 'max-w-[80px] min-w-[80px]' : isChatPage ? 'max-w-[80px] min-w-[80px]' : 'max-w-[245px] min-w-[245px]'
          }`}>
        <div className='py-8 h-full  z-[1000]'>
          <div className={`flex z-[100]  ${textVisible ? ' mb-[29px] pl-6' : isChatPage ? 'mb-[29px] pl-6' : 'pl-6 mb-6'}`}>
            {textVisible || isChatPage ? (
              ...
              return (
                <Link href={item.link || ''} key={index}>
                  ...
                  >
                    ...
                    <p
                      className={`transition-all duration-700 ${textVisible || isChatPage ? 'opacity-0' : 'opacity-100'
                        }`}
                    >{item.text}</p>
                  </div>
                </Link>
