        ...
        <div className='w-full max-w-[900px] mx-auto relative'>
            ...
            <div className='flex gap-12 text-[12px] justify-center py-7 -my-[29px] uppercase tracking-[2px]'>
                ...
                <Link href={'/profilesaved'}>
                    <div className='flex gap-2 items-center cursor-pointer font-semibold text-gray-400 pt-5'>
                        <span><BiBookmark /></span>
                        <span>Saved</span>
                    </div>
                </Link>
                <Link href={'/profiletagged'}>
                    <div className='flex gap-2 items-center cursor-pointer border-t border-t-gray-500 pt-5'>
            ...
            <div className='text-center py-20'>
                <div className='flex justify-center pb-5'>
                    <Image src={'/profile.svg'} alt={''} width={60} height={60} />
                </div>
                <h2 className='text-3xl font-extrabold pb-4'>Photos of you</h2>
